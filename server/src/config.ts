...
export class Config {
    ...
    'jhipster.mail.from' = 'jhipster@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'jhipster API';
    ...
    'eureka.instance.appname' = 'jhipster';
    'eureka.instance.instanceId' = 'jhipster:${random.value}';
